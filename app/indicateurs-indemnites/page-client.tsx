...
import { Fuel, Users, FileText, Info, RefreshCw } from "lucide-react"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="space-y-8">
          ...
          <Alert>
            ...
            <AlertDescription>
              Les données sont mises à jour quotidiennement. Les prix carburant proviennent des stations-service
              françaises, les indicateurs sociaux des sources officielles (Légifrance, URSSAF, conventions collectives).
            </AlertDescription>
          </Alert>
