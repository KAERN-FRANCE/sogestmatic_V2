...
export async function GET(req: Request) {
  try {
    ...
    const prompt = `Tu es un expert paie/URSSAF. Fais une recherche web et renvoie STRICTEMENT un JSON avec un tableau "items" listant les indicateurs sociaux clés en France pour le transport routier. Les 4 indicateurs recherchés sont:
1. SMIC horaire brut (France métropolitaine) - environ 12,02 €/h en 2025
2. Taux horaire conventionnel minimum transport routier - environ 12,27 €/h
3. Charges sociales patronales moyennes - environ 42%
4. Taux CSG + CRDS combinés sur revenus d'activité - IMPORTANT: c'est 9,7% au total (9,2% CSG + 0,5% CRDS), pas seulement 0,5%
