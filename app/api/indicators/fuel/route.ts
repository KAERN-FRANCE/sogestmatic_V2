...
export async function GET(req: Request) {
  try {
    ...
    const prompt = `Recherche les prix moyens actuels des carburants en France. Renvoie UNIQUEMENT un JSON valide avec ce format exact, sans aucun texte avant ou après:
{
...
- Les prix doivent être en €/litre avec 2-3 décimales (ex: 1.629)
- change7d = variation sur 7 jours (positif si hausse, négatif si baisse)
- Utilise des sources officielles: carburants.gouv.fr, prix-carburants.gouv.fr, service-public.fr`
