...
const CACHE_DURATION = 24 * 60 * 60 * 1000 // 24 hours - refreshed daily at 6:00 AM
        ...
        <div className="space-y-8">
          ...
          <Alert>
            ...
            <AlertDescription className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
              <span>
                Données mises à jour automatiquement chaque jour à 6h. Sources : EUR-Lex, Légifrance, Ministère des Transports.
              </span>
          ...
          <Card className="bg-muted/50">
            <CardContent className="pt-6">
              <div className="text-center text-sm text-muted-foreground">
                <p>
                  Cette veille réglementaire est mise à jour automatiquement chaque jour à 6h du matin.
